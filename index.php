            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Квалифицированные инструкторы</h5>
                        <p>Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Занятия дистанционно</h5>
                        <p>Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Домашние проекты</h5>
                        <p>Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3">Книжная библиотека</h5>
                        <p>Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                <h1 class="mb-4">Добро пожаловать в онлайн школу базу знаний Lavr School</h1>
                <p class="mb-4">Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                <p class="mb-4">Нерпы — очень проворные и выносливые. Эти животные способны разогнаться до 25 км/ч под водой.</p>
                <div class="row gy-2 gx-4 mb-4">
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>инструкторы</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>дистанционное обучение</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Интернациональные сертификаты</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Учителя</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right text-primary me-2"></i>Группы для общения</p>
                    </div>
                    <div class="col-sm-6">
...
<div class="container-xxl py-5 category">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-5">Категории существующих у нас курсов</h1>
        </div>
        <div class="row g-3">
                    ...
                    <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                        <a class="position-relative d-block overflow-hidden" href="#">
                            ...
                            <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                ...
                                <small class="text-primary">36 Курсов</small>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                        <a class="position-relative d-block overflow-hidden" href="#">
                            ...
                            <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                ...
                                <small class="text-primary">21 Курс</small>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                        <a class="position-relative d-block overflow-hidden" href="#">
                            ...
                            <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                                ...
                                <small class="text-primary">30 Курсов</small>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                <a class="position-relative d-block h-100 overflow-hidden" href="#">
                    ...
                    <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin:  1px;">
                        ...
                        <small class="text-primary">56 Курсов</small>
                    </div>
                </a>
            </div>
        </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-5">Наши самые популярные курсы</h1>
        </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-5">Эксперты в сфере онлайн обучения</h1>
        </div>
        <div class="row g-4">
...
<div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        <div class="text-center">
            <h1 class="mb-5">Наши студенты пишут!</h1>
        </div>
