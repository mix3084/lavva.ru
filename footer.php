        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Г. Москва, Сиреневый бульвар 4г.</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-white mb-3">Обратная связь</h4>
                    <p>тут надо нам писать свои пожелания </p>
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="text" placeholder="Твое Сообщение">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Сделано Лавришиным Сергеем в Балашихе</a>
                    </div>
